...
<head>
    ...
    <title>订单管理</title>
    <link rel='stylesheet' href='css/ordersManage.css'>
    <script src="js/ordersManage.js"></script>
       		...
       		<div class="w">
            	<div class="cart_header">
                    ...
                    <li class="product">
                        ...
                        <span style="margin-left:10px;font-size:15px;">订单号：<b>${item.key.ordersId }</b></span>
                    </li>
                    <li>
                         <span>单价</span>
                ...
                <li>
                    <div class="goodsItem">
                        <ul>
                            ...
                            <li>
                            	<input type="button" onclick="updateStatus(this)" value="发货">
                            </li>
                        </ul>
                    </div>
               	 </li>
